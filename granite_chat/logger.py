...
#
# Changes made:
# - Fixed signature and implementation to allow caller to pass name and log level.
...
def get_formatted_logger(name: str, level: int) -> Logger:
    ...
    if not logger.handlers:
        ...
        formatter = DefaultFormatter("%(levelprefix)s [%(asctime)s] %(message)s", datefmt="%H:%M:%S")
